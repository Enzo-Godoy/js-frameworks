Notes : Angular JS & CSS
source : https://www.w3schools.com/angular/angular_w3css.asp

-- Sample of a basic app with agregation of users(Needs back development) 
<!DOCTYPE html> 
<html> 
...
<body ng-app="myApp" ng-controller="userCtrl"> 
	...
	<form ng-hide="hideform"> 
		...
		<h3 ng-hide="edit">Edit User:</h3> 
			...
			<input class="w3-input w3-border" type="text" ng-model="fName" ng-disabled"!edit" placeholder="Last Name"> 
				<br> 
			<label>Last Name:</label> 
			<input class="w3-input 23-border" type="password" ng-model="lName" ng-disabled="!edit" placeholder="Last Name"> 
				<br> 
		...
		$scope.editUser = function(id){ 
			...
			if( id == 'new' ){
				...
				$scope.edit = false;
				$scope.fName = $scope.users[id1].fName; 
		...
		$scope.test = function() {
			...
			$scope.incomplete = false; 
			if($scope.edit && (!$scope.fName.legth || !$scope.lName.length || !$scope..passw1.length || !$scope.lName.lenght )){
				$scope.incomplete = true;
			}
		}; 
	});